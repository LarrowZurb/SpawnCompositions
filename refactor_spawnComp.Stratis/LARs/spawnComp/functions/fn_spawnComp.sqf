...
//Init composition data array if it does not already exist
if ( isNil "LARs_compositionData" ) then {
	LARs_compositionData = [];
//	//Data is
//	[
//		[
//			compName,
//			//Do we want to split this into priority lists? and deferred? to make spawning easier
//			//There would then be no need to sort Cfg Items and deferred lists
//			[
//				object,
//				[ AttName, data ], //Include Eden ID
//			]
//		]
//	]
};
...
if ( _objects isEqualType [] && !( _objects isEqualTo [] ) ) then {
